    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 pt-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        <motion.div 
          ...
          className="absolute top-20 left-20 w-72 h-72 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl"
        />
        <motion.div 
          animate={{
            scale: [1, 1.1, 1],
        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute inset-0 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 rounded-full blur-2xl opacity-60"
            />
            <motion.div 
              animate={{ rotate: -360 }}
              transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
              className="absolute inset-0 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full blur-xl opacity-40"
            />
            <motion.img 
          ...
          <motion.p 
            ...
            className="text-xl md:text-2xl text-blue-300 mb-6 font-semibold"
          >
            Full Stack Developer | AI Enthusiast | Compititive Programmesr
          </motion.p>
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#projects"
              className="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg"
            >
              View Projects
            </motion.a>
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#contact"
              className="px-8 py-3 bg-gray-800/50 backdrop-blur-sm text-blue-300 rounded-full hover:bg-gray-700/50 transition-all shadow-lg border border-blue-400/30 hover:border-blue-400/60"
            >
              Get in Touch
            </motion.a>
          </motion.div>
