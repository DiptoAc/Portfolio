    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 pt-20">
      <div className="container mx-auto px-6 py-20">
        <div className="flex flex-col items-center text-center">
          <div className="mb-8">
            <div className="w-32 h-32 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-center text-white text-5xl font-bold shadow-xl">
              SA
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a
              href="#contact"
              className="px-8 py-3 bg-white text-blue-600 rounded-full hover:bg-gray-50 transition-colors shadow-lg border border-blue-600"
            >
              Get in Touch
            </a>
          </div>
