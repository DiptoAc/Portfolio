        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                <svg className="w-6 h-6 flex-shrink-0 text-blue-600 mt-1 mr-4" width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                <motion.a
                  ...
                  className="p-3 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full hover:from-blue-100 hover:to-blue-200 transition-all shadow-md"
                >
