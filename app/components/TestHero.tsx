  ...
  return (
    ...
    >
      ...
      >
        ...
        style={{ 
            transform: "translate3d(0, 0, 0)", // Forces 3D GPU layer
            willChange: "transform, opacity",  // Pre-allocates GPU memory
            backfaceVisibility: "hidden",      // Prevents micro-stutters
            perspective: 1000                  // Creates a fresh 3D context
        }}
        >
